...
`func (o *PatchedWritableConsolePortRequest) GetCustomFields() map[string]string`

GetCustomFields returns the CustomFields field if non-nil, zero value otherwise.

### GetCustomFieldsOk

`func (o *PatchedWritableConsolePortRequest) GetCustomFieldsOk() (*map[string]string, bool)`
...
`func (o *PatchedWritableConsolePortRequest) SetCustomFields(v map[string]string)`
