...
`func (o *PatchedWritableDeviceTypeRequest) GetCustomFields() map[string]string`

GetCustomFields returns the CustomFields field if non-nil, zero value otherwise.

### GetCustomFieldsOk

`func (o *PatchedWritableDeviceTypeRequest) GetCustomFieldsOk() (*map[string]string, bool)`
...
`func (o *PatchedWritableDeviceTypeRequest) SetCustomFields(v map[string]string)`
