...
`func (o *PowerOutletRequest) GetCustomFields() map[string]string`

GetCustomFields returns the CustomFields field if non-nil, zero value otherwise.

### GetCustomFieldsOk

`func (o *PowerOutletRequest) GetCustomFieldsOk() (*map[string]string, bool)`
...
`func (o *PowerOutletRequest) SetCustomFields(v map[string]string)`
