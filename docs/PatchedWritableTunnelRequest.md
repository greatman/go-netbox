...
`func (o *PatchedWritableTunnelRequest) GetCustomFields() map[string]string`

GetCustomFields returns the CustomFields field if non-nil, zero value otherwise.

### GetCustomFieldsOk

`func (o *PatchedWritableTunnelRequest) GetCustomFieldsOk() (*map[string]string, bool)`
...
`func (o *PatchedWritableTunnelRequest) SetCustomFields(v map[string]string)`
