...
`func (o *WritableIPAddressRequest) GetCustomFields() map[string]string`

GetCustomFields returns the CustomFields field if non-nil, zero value otherwise.

### GetCustomFieldsOk

`func (o *WritableIPAddressRequest) GetCustomFieldsOk() (*map[string]string, bool)`
...
`func (o *WritableIPAddressRequest) SetCustomFields(v map[string]string)`
