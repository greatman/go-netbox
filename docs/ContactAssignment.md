...
`func (o *ContactAssignment) GetCustomFields() map[string]string`

GetCustomFields returns the CustomFields field if non-nil, zero value otherwise.

### GetCustomFieldsOk

`func (o *ContactAssignment) GetCustomFieldsOk() (*map[string]string, bool)`
...
`func (o *ContactAssignment) SetCustomFields(v map[string]string)`
