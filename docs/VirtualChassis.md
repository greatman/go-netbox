...
`func (o *VirtualChassis) GetCustomFields() map[string]string`

GetCustomFields returns the CustomFields field if non-nil, zero value otherwise.

### GetCustomFieldsOk

`func (o *VirtualChassis) GetCustomFieldsOk() (*map[string]string, bool)`
...
`func (o *VirtualChassis) SetCustomFields(v map[string]string)`
