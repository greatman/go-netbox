...
`func (o *PatchedWritableClusterRequest) GetCustomFields() map[string]string`

GetCustomFields returns the CustomFields field if non-nil, zero value otherwise.

### GetCustomFieldsOk

`func (o *PatchedWritableClusterRequest) GetCustomFieldsOk() (*map[string]string, bool)`
...
`func (o *PatchedWritableClusterRequest) SetCustomFields(v map[string]string)`
