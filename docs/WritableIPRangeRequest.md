...
`func (o *WritableIPRangeRequest) GetCustomFields() map[string]string`

GetCustomFields returns the CustomFields field if non-nil, zero value otherwise.

### GetCustomFieldsOk

`func (o *WritableIPRangeRequest) GetCustomFieldsOk() (*map[string]string, bool)`
...
`func (o *WritableIPRangeRequest) SetCustomFields(v map[string]string)`
