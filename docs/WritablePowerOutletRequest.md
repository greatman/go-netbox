...
`func (o *WritablePowerOutletRequest) GetCustomFields() map[string]string`

GetCustomFields returns the CustomFields field if non-nil, zero value otherwise.

### GetCustomFieldsOk

`func (o *WritablePowerOutletRequest) GetCustomFieldsOk() (*map[string]string, bool)`
...
`func (o *WritablePowerOutletRequest) SetCustomFields(v map[string]string)`
