...
`func (o *WritableDeviceTypeRequest) GetCustomFields() map[string]string`

GetCustomFields returns the CustomFields field if non-nil, zero value otherwise.

### GetCustomFieldsOk

`func (o *WritableDeviceTypeRequest) GetCustomFieldsOk() (*map[string]string, bool)`
...
`func (o *WritableDeviceTypeRequest) SetCustomFields(v map[string]string)`
