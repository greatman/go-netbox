...
`func (o *Service) GetCustomFields() map[string]string`

GetCustomFields returns the CustomFields field if non-nil, zero value otherwise.

### GetCustomFieldsOk

`func (o *Service) GetCustomFieldsOk() (*map[string]string, bool)`
...
`func (o *Service) SetCustomFields(v map[string]string)`
