...
`func (o *PatchedWritableTunnelTerminationRequest) GetCustomFields() map[string]string`

GetCustomFields returns the CustomFields field if non-nil, zero value otherwise.

### GetCustomFieldsOk

`func (o *PatchedWritableTunnelTerminationRequest) GetCustomFieldsOk() (*map[string]string, bool)`
...
`func (o *PatchedWritableTunnelTerminationRequest) SetCustomFields(v map[string]string)`
