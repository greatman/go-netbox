...
`func (o *DeviceTypeRequest) GetCustomFields() map[string]string`

GetCustomFields returns the CustomFields field if non-nil, zero value otherwise.

### GetCustomFieldsOk

`func (o *DeviceTypeRequest) GetCustomFieldsOk() (*map[string]string, bool)`
...
`func (o *DeviceTypeRequest) SetCustomFields(v map[string]string)`
