...
`func (o *ASNRange) GetCustomFields() map[string]string`

GetCustomFields returns the CustomFields field if non-nil, zero value otherwise.

### GetCustomFieldsOk

`func (o *ASNRange) GetCustomFieldsOk() (*map[string]string, bool)`
...
`func (o *ASNRange) SetCustomFields(v map[string]string)`
