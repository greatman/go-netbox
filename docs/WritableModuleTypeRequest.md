...
`func (o *WritableModuleTypeRequest) GetCustomFields() map[string]string`

GetCustomFields returns the CustomFields field if non-nil, zero value otherwise.

### GetCustomFieldsOk

`func (o *WritableModuleTypeRequest) GetCustomFieldsOk() (*map[string]string, bool)`
...
`func (o *WritableModuleTypeRequest) SetCustomFields(v map[string]string)`
