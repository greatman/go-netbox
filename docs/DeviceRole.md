...
`func NewDeviceRole(id int64, url string, displayUrl string, display string, name string, slug string, created NullableTime, lastUpdated NullableTime, ) *DeviceRole`
...
`func (o *DeviceRole) GetId() int64`

GetId returns the Id field if non-nil, zero value otherwise.

### GetIdOk

`func (o *DeviceRole) GetIdOk() (*int64, bool)`
...
`func (o *DeviceRole) SetId(v int64)`
...
`func (o *DeviceRole) GetCustomFields() map[string]string`

GetCustomFields returns the CustomFields field if non-nil, zero value otherwise.

### GetCustomFieldsOk

`func (o *DeviceRole) GetCustomFieldsOk() (*map[string]string, bool)`
...
`func (o *DeviceRole) SetCustomFields(v map[string]string)`
