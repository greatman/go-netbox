...
`func (o *ASNRangeRequest) GetCustomFields() map[string]string`

GetCustomFields returns the CustomFields field if non-nil, zero value otherwise.

### GetCustomFieldsOk

`func (o *ASNRangeRequest) GetCustomFieldsOk() (*map[string]string, bool)`
...
`func (o *ASNRangeRequest) SetCustomFields(v map[string]string)`
