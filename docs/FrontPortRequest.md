...
`func (o *FrontPortRequest) GetCustomFields() map[string]string`

GetCustomFields returns the CustomFields field if non-nil, zero value otherwise.

### GetCustomFieldsOk

`func (o *FrontPortRequest) GetCustomFieldsOk() (*map[string]string, bool)`
...
`func (o *FrontPortRequest) SetCustomFields(v map[string]string)`
