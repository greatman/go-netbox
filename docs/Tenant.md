...
`func NewTenant(id int64, url string, displayUrl string, display string, name string, slug string, created NullableTime, lastUpdated NullableTime, ipaddressCount int64, siteCount int64, vrfCount int64, clusterCount int64, ) *Tenant`
...
`func (o *Tenant) GetCustomFields() map[string]string`

GetCustomFields returns the CustomFields field if non-nil, zero value otherwise.

### GetCustomFieldsOk

`func (o *Tenant) GetCustomFieldsOk() (*map[string]string, bool)`
...
`func (o *Tenant) SetCustomFields(v map[string]string)`
