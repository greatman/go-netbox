...
`func (o *WritableRackTypeRequest) GetUHeight() int64`

GetUHeight returns the UHeight field if non-nil, zero value otherwise.

### GetUHeightOk

`func (o *WritableRackTypeRequest) GetUHeightOk() (*int64, bool)`
...
`func (o *WritableRackTypeRequest) SetUHeight(v int64)`
...
`func (o *WritableRackTypeRequest) GetStartingUnit() int64`

GetStartingUnit returns the StartingUnit field if non-nil, zero value otherwise.

### GetStartingUnitOk

`func (o *WritableRackTypeRequest) GetStartingUnitOk() (*int64, bool)`
...
`func (o *WritableRackTypeRequest) SetStartingUnit(v int64)`
...
`func (o *WritableRackTypeRequest) GetOuterWidth() int64`

GetOuterWidth returns the OuterWidth field if non-nil, zero value otherwise.

### GetOuterWidthOk

`func (o *WritableRackTypeRequest) GetOuterWidthOk() (*int64, bool)`
...
`func (o *WritableRackTypeRequest) SetOuterWidth(v int64)`
...
`func (o *WritableRackTypeRequest) GetOuterDepth() int64`

GetOuterDepth returns the OuterDepth field if non-nil, zero value otherwise.

### GetOuterDepthOk

`func (o *WritableRackTypeRequest) GetOuterDepthOk() (*int64, bool)`
...
`func (o *WritableRackTypeRequest) SetOuterDepth(v int64)`
...
`func (o *WritableRackTypeRequest) GetMaxWeight() int64`

GetMaxWeight returns the MaxWeight field if non-nil, zero value otherwise.

### GetMaxWeightOk

`func (o *WritableRackTypeRequest) GetMaxWeightOk() (*int64, bool)`
...
`func (o *WritableRackTypeRequest) SetMaxWeight(v int64)`
...
`func (o *WritableRackTypeRequest) GetMountingDepth() int64`

GetMountingDepth returns the MountingDepth field if non-nil, zero value otherwise.

### GetMountingDepthOk

`func (o *WritableRackTypeRequest) GetMountingDepthOk() (*int64, bool)`
...
`func (o *WritableRackTypeRequest) SetMountingDepth(v int64)`
...
`func (o *WritableRackTypeRequest) GetCustomFields() map[string]string`

GetCustomFields returns the CustomFields field if non-nil, zero value otherwise.

### GetCustomFieldsOk

`func (o *WritableRackTypeRequest) GetCustomFieldsOk() (*map[string]string, bool)`
...
`func (o *WritableRackTypeRequest) SetCustomFields(v map[string]string)`
