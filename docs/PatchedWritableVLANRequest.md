...
`func (o *PatchedWritableVLANRequest) GetCustomFields() map[string]string`

GetCustomFields returns the CustomFields field if non-nil, zero value otherwise.

### GetCustomFieldsOk

`func (o *PatchedWritableVLANRequest) GetCustomFieldsOk() (*map[string]string, bool)`
...
`func (o *PatchedWritableVLANRequest) SetCustomFields(v map[string]string)`
