...
`func (o *PatchedPlatformRequest) GetCustomFields() map[string]string`

GetCustomFields returns the CustomFields field if non-nil, zero value otherwise.

### GetCustomFieldsOk

`func (o *PatchedPlatformRequest) GetCustomFieldsOk() (*map[string]string, bool)`
...
`func (o *PatchedPlatformRequest) SetCustomFields(v map[string]string)`
