...
`func (o *VirtualDisk) GetCustomFields() map[string]string`

GetCustomFields returns the CustomFields field if non-nil, zero value otherwise.

### GetCustomFieldsOk

`func (o *VirtualDisk) GetCustomFieldsOk() (*map[string]string, bool)`
...
`func (o *VirtualDisk) SetCustomFields(v map[string]string)`
