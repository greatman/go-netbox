...
`func (o *CableRequest) GetCustomFields() map[string]string`

GetCustomFields returns the CustomFields field if non-nil, zero value otherwise.

### GetCustomFieldsOk

`func (o *CableRequest) GetCustomFieldsOk() (*map[string]string, bool)`
...
`func (o *CableRequest) SetCustomFields(v map[string]string)`
