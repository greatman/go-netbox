...
`func (o *Tunnel) GetCustomFields() map[string]string`

GetCustomFields returns the CustomFields field if non-nil, zero value otherwise.

### GetCustomFieldsOk

`func (o *Tunnel) GetCustomFieldsOk() (*map[string]string, bool)`
...
`func (o *Tunnel) SetCustomFields(v map[string]string)`
