...
`func (o *PatchedWritableConsoleServerPortRequest) GetCustomFields() map[string]string`

GetCustomFields returns the CustomFields field if non-nil, zero value otherwise.

### GetCustomFieldsOk

`func (o *PatchedWritableConsoleServerPortRequest) GetCustomFieldsOk() (*map[string]string, bool)`
...
`func (o *PatchedWritableConsoleServerPortRequest) SetCustomFields(v map[string]string)`
