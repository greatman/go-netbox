...
`func (o *PatchedWritableIPRangeRequest) GetCustomFields() map[string]string`

GetCustomFields returns the CustomFields field if non-nil, zero value otherwise.

### GetCustomFieldsOk

`func (o *PatchedWritableIPRangeRequest) GetCustomFieldsOk() (*map[string]string, bool)`
...
`func (o *PatchedWritableIPRangeRequest) SetCustomFields(v map[string]string)`
