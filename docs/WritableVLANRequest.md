...
`func (o *WritableVLANRequest) GetCustomFields() map[string]string`

GetCustomFields returns the CustomFields field if non-nil, zero value otherwise.

### GetCustomFieldsOk

`func (o *WritableVLANRequest) GetCustomFieldsOk() (*map[string]string, bool)`
...
`func (o *WritableVLANRequest) SetCustomFields(v map[string]string)`
