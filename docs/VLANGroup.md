...
`func NewVLANGroup(id int64, url string, displayUrl string, display string, name string, slug string, scope interface{}, created NullableTime, lastUpdated NullableTime, utilization string, ) *VLANGroup`
...
`func (o *VLANGroup) GetCustomFields() map[string]string`

GetCustomFields returns the CustomFields field if non-nil, zero value otherwise.

### GetCustomFieldsOk

`func (o *VLANGroup) GetCustomFieldsOk() (*map[string]string, bool)`
...
`func (o *VLANGroup) SetCustomFields(v map[string]string)`
