...
`func (o *WirelessLinkRequest) GetCustomFields() map[string]string`

GetCustomFields returns the CustomFields field if non-nil, zero value otherwise.

### GetCustomFieldsOk

`func (o *WirelessLinkRequest) GetCustomFieldsOk() (*map[string]string, bool)`
...
`func (o *WirelessLinkRequest) SetCustomFields(v map[string]string)`
