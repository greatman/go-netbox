...
`func (o *WritablePrefixRequest) GetCustomFields() map[string]string`

GetCustomFields returns the CustomFields field if non-nil, zero value otherwise.

### GetCustomFieldsOk

`func (o *WritablePrefixRequest) GetCustomFieldsOk() (*map[string]string, bool)`
...
`func (o *WritablePrefixRequest) SetCustomFields(v map[string]string)`
