...
`func (o *ConsolePortRequest) GetCustomFields() map[string]string`

GetCustomFields returns the CustomFields field if non-nil, zero value otherwise.

### GetCustomFieldsOk

`func (o *ConsolePortRequest) GetCustomFieldsOk() (*map[string]string, bool)`
...
`func (o *ConsolePortRequest) SetCustomFields(v map[string]string)`
