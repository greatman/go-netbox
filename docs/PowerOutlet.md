...
`func (o *PowerOutlet) GetCustomFields() map[string]string`

GetCustomFields returns the CustomFields field if non-nil, zero value otherwise.

### GetCustomFieldsOk

`func (o *PowerOutlet) GetCustomFieldsOk() (*map[string]string, bool)`
...
`func (o *PowerOutlet) SetCustomFields(v map[string]string)`
