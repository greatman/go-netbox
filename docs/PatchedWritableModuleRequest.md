...
`func (o *PatchedWritableModuleRequest) GetCustomFields() map[string]string`

GetCustomFields returns the CustomFields field if non-nil, zero value otherwise.

### GetCustomFieldsOk

`func (o *PatchedWritableModuleRequest) GetCustomFieldsOk() (*map[string]string, bool)`
...
`func (o *PatchedWritableModuleRequest) SetCustomFields(v map[string]string)`
