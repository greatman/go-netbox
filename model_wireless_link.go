...
type WirelessLink struct {
	...
	DistanceUnit NullableWirelessLinkDistanceUnit `json:"distance_unit,omitempty"`
...
func (o *WirelessLink) GetDistanceUnit() WirelessLinkDistanceUnit {
	if o == nil || IsNil(o.DistanceUnit.Get()) {
		var ret WirelessLinkDistanceUnit
		return ret
	}
...
// SetDistanceUnit gets a reference to the given NullableWirelessLinkDistanceUnit and assigns it to the DistanceUnit field.
