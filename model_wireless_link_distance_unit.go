...
type WirelessLinkDistanceUnit struct {
	Value *PatchedWritableWirelessLinkRequestDistanceUnit `json:"value,omitempty"`
...
// SetValue gets a reference to the given PatchedWritableWirelessLinkRequestDistanceUnit and assigns it to the Value field.
