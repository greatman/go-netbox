...
func (o *WirelessLinkRequest) GetDistanceUnit() WirelessLinkRequestDistanceUnit {
	if o == nil || IsNil(o.DistanceUnit.Get()) {
		var ret WirelessLinkRequestDistanceUnit
		return ret
	}
...
// SetDistanceUnit gets a reference to the given NullableWirelessLinkRequestDistanceUnit and assigns it to the DistanceUnit field.
