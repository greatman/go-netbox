...
type PatchedWritableInterfaceRequest struct {
	...
	RfChannel *WirelessChannel1 `json:"rf_channel,omitempty"`
...
// SetRfRole gets a reference to the given WirelessRole1 and assigns it to the RfRole field.
...
// SetRfChannel gets a reference to the given WirelessChannel1 and assigns it to the RfChannel field.
